...
GAMES = [{
  ...
  'db_name': 'League of Legends',
  'names': ['lol', 'league of legends']
}, {
  'db_name': 'Counter-Strike: Global Offensive',
  'names': ['counter-strike: global offensive', 'cs:go', 'csgo']
}]
