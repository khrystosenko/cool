...
def filter_by_params(user_id, game, platform, stream, only_online, offset, limit):
    data = search.get_by_params(user_id, game, platform, stream, only_online, offset, limit)
    return {'data': data}
